                  ...
                  <div className="space-y-3">
                    ...
                    {ideas.length === 0 && (
                      <p className="text-sm text-gray-500 text-center py-4">
                        暂无创意，<Link href="/ideas" className="text-blue-600 hover:text-blue-800">创建第一个创意</Link>
                      </p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    {projects.filter(p => p.featured).length === 0 && (
                      <p className="text-sm text-gray-500 text-center py-4">
                        暂无精选项目，<Link href="/projects" className="text-blue-600 hover:text-blue-800">创建项目</Link>
                      </p>
                    )}
                  </div>
                </div>
